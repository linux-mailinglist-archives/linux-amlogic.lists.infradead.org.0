...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 408BF4D195
	for <lists+linux-amlogic@lfdr.de>; Thu, 20 Jun 2019 17:06:41 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	List-Owner; bh=O+L4A75dyC62CEMupc1FWNppeTIqSk6t3Ymo2CCs634=; b=oDviHdO0ssbfQn
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92 #3 (Red Hat Linux))
	id 1hdye7-0000m8-CU; Thu, 20 Jun 2019 15:06:39 +0000
Received: from mail-wr1-x442.google.com ([2a00:1450:4864:20::442])
 by bombadil.infradead.org with esmtps (Exim 4.92 #3 (Red Hat Linux))
 id 1hdyYD-0003Hl-GD
 for linux-amlogic@lists.infradead.org; Thu, 20 Jun 2019 15:00:46 +0000
Received: by mail-wr1-x442.google.com with SMTP id f9so3341480wre.12
 for <linux-amlogic@lists.infradead.org>; Thu, 20 Jun 2019 08:00:33 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=baylibre-com.20150623.gappssmtp.com; s=20150623;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=eQkY2dGFw4JhflCUeezs1wtLLvO0l7bkLcOQTL5Omig=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=eQkY2dGFw4JhflCUeezs1wtLLvO0l7bkLcOQTL5Omig=;
 b=
X-Gm-Message-State: APjAAAXTTTPY3Kx1TvMpYK/n7z8XJfxfVl+lxBlX4K6HolyfGF1dytg4
 FwIKEbaiksI2n1D3PspCnhqSOA==
X-Google-Smtp-Source: APXvYqxBQcMGZDhDOZ8Z5c3oXJmO2eLPnLUEUHJ+ChiQ2bewk5P0lpSuBPm4iPy136eC1yKOd0ChcQ==
X-Received: by 2002:a05:6000:11cc:: with SMTP id
 i12mr34772232wrx.243.1561042830684; 
 Thu, 20 Jun 2019 08:00:30 -0700 (PDT)
Received: from bender.baylibre.local
 (lmontsouris-657-1-212-31.w90-63.abo.wanadoo.fr. [90.63.244.31])
 by smtp.gmail.com with ESMTPSA id o126sm6802520wmo.1.2019.06.20.08.00.29
 (version=TLS1_2 cipher=ECDHE-RSA-AES128-SHA bits=128/128);
 Thu, 20 Jun 2019 08:00:30 -0700 (PDT)
From: Neil Armstrong <narmstrong@baylibre.com>
To: jbrunet@baylibre.com,
	khilman@baylibre.com
Subject: [RFC/RFT 09/14] arm64: dts: move common G12A & G12B modes to
 meson-g12-common.dtsi
Date: Thu, 20 Jun 2019 17:00:08 +0200
Message-Id: <20190620150013.13462-10-narmstrong@baylibre.com>
X-Mailer: git-send-email 2.21.0
In-Reply-To: <20190620150013.13462-1-narmstrong@baylibre.com>
References: <20190620150013.13462-1-narmstrong@baylibre.com>
MIME-Version: 1.0
X-Spam-Note: CRM114 run bypassed due to message size (124944 bytes)
X-Spam-Score: 0.0 (/)
...
---
 .../boot/dts/amlogic/meson-g12-common.dtsi    | 2456 +++++++++++++++++
 arch/arm64/boot/dts/amlogic/meson-g12a.dtsi   | 2452 +---------------
 arch/arm64/boot/dts/amlogic/meson-g12b.dtsi   |   26 +-
 3 files changed, 2483 insertions(+), 2451 deletions(-)
 create mode 100644 arch/arm64/boot/dts/amlogic/meson-g12-common.dtsi

diff --git a/arch/arm64/boot/dts/amlogic/meson-g12-common.dtsi b/arch/arm64/boot/dts/amlogic/meson-g12-common.dtsi
new file mode 100644
index 000000000000..2baa04303762
--- /dev/null
...
index 58a6a9c4bcfc..ac15967bb7fa 100644
...
index 9e88e513b22d..ae63cd610892 100644
